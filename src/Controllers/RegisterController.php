...
use Phpunittest\Email\SendEmail;
use Phpunittest\Models\User;
use Phpunittest\Models\UserPending;
...
class RegisterController extends BaseController {
    ...
    public function postShowRegisterPage()
    {
        ...
        if ($valid) {
            ...
            SendEmail::sendEmail($user->email, "Welcome to Phpunittest", $message);
